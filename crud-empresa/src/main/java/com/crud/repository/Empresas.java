...
public class Empresas implements Serializable {
	...
	public List<Empresa> pesquisar(String nome) {
		String jpql = "from Empresa where nomeEmpresa like :nomeEmpresa"; //Pode buscar o nome das empresas sem o nome completo
	...
	public Empresa guardar (Empresa empresa) {
		return manager.merge(empresa); //merge -> vai atualizar com o DB, por ex
									//se eu to passando uma empresa e ela ainda nao existe, ele vai salvar essa empresa (INSE RT)
